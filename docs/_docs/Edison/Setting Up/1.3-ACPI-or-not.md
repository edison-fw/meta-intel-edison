...
Currently we are working on fixing this for the ACPI case. The status of this work can be followed at the [Intel Edison Wiki](https://edison-fw.github.io/edison-wiki/acpi).
