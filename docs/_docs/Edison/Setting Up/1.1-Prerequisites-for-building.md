...
## Building the Gatesgarth branches on Ubuntu Groovy

Yocto Gatesgarth will build on Ubuntu Groovy (20.10).
...
## Building the Gatesgarth branches from an Ubuntu LTS container (Bionic)
