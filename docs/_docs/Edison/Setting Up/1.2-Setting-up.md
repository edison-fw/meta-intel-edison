...
You can also checkout dizzy-uptodate, dizzy-latest, dizzy-rt or morty, pyro64 or pyro64-acpi.

Master is currently based on rocko32. rocko64-acpi enabled x86_64 and acpi on top of that.
