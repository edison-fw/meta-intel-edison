...
### 1 - 3. Starting point: ext4 Gatesgarth image with `btrfs` patches
...
### 4. Boot into  ext4 Gatesgarth image

Rebooting Edison should take you into Gatesgarth on mmcblk0p8 (`rootfs`).
