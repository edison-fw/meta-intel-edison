...
---
## Not breaking things
The Morty, Pyro, Rocko, Sumo, Thud, Warrior branches are experimental. Currently they build. install and boot. For Morty the separate parts (u-boot, kernel and rootfs) must be installed manually. After Pyro this is optional, you can use flashall or Flash Tool Lite and overwrite your factory image.
...
If you use flashall or Flash Tool Lite the factory image is gone, but your new Warrior will boot automatically.
